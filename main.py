...
def generate():
    ...
    if 'profile_pic' not in request.files:
        return render_template('index.html', error="Profil fotoğrafı yüklenmedi")
    
    profile_pic = request.files['profile_pic']
    if profile_pic.filename == '':
        return render_template('index.html', error="Geçerli bir fotoğraf seçin")
    ...
    try:
        ...
        # Görüntüleri harmanla (basit blending)
